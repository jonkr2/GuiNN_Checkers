...
inline int32_t horizontalSum_8x32(__m256i v)
{
...
inline int32_t horizontalSum_4x32(__m128i v)
{
...
inline int dotProductSimdInt32(const int32_t* v1, const int32_t* v2, size_t count)
{
	assert((count & 7) == 0);
...
inline int dotProductSimdInt16(const int16_t* v1, const int16_t* v2, size_t count)
{
	assert((count & 15) == 0);
...
inline float dotProductSimdFloat(const float* v1, const float* v2, size_t count)
{
...
// v1 = v1 + v2
inline void addVecSimd16(int16_t* v1, const int16_t* v2, size_t count)
{
	assert((count & 15) == 0);
...
// v1 = v1 + v2
inline void addVecSimd32(int32_t* v1, const int32_t* v2, size_t count)
{
	assert((count & 7) == 0);
...
// v1 = v1 - v2
inline void subVecSimd16(int32_t* v1, const int32_t* v2, size_t count)
{
	assert((count & 15) == 0);
	const int32_t* v1End = v1 + count;
...
inline void addMulVecSimd32(int32_t* o, const int32_t* weights, const int32_t val, size_t count)
{
	assert((count & 7) == 0);
